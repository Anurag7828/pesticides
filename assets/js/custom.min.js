	...
	var e = function () {
		...
		o = function () {
			...
			$(".svg-btn").on("click", function () {
				...
				$(this).closest(".svg-icons-ov").find(".modal-title").text(t),
				...
				$(".img-btn").on("click", function () {
					...
					var e,
						...
						n,
						s =
							((e = document.querySelector(".svg-icons-prev").innerHTML),
			...
			$("#checkAll").on("change", function () {
				...
				$(".checkAll").on("click", function () {
					jQuery(this)
						...
						.find('input[type="checkbox"]:not(.star-checkbox)')
					...
					function (t) {
						...
						$(this).data("tipText", a).removeAttr("title"),
							$('<p class="tooltip"></p>')
								.text(a)
								.appendTo("body")
								.css("top", e.offset().top - e.height() - 16 + "px")
								.css(
									"left",
									e.offset().left - $(".tooltip").width() / 2 + 10 + "px"
								)
								.fadeIn("slow");
					},
					function () {
