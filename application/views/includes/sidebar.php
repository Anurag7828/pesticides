      ...
      <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
					...
					<li><a class="" href="<?= base_url() ?>" aria-expanded="false">
						<div class="menu-icon">
					...
					<div class="menu-icon">
						...
						<ul aria-expanded="false">	
							<li><a href="<?= base_url() ?>add_users">Add User</a></li>
							<li><a href="<?= base_url() ?>view_users">Active User List</a></li>
							<li><a href="<?= base_url() ?>deactive_users">Dective User List</a></li>
					...
					<div class="menu-icon">
						...
						<ul aria-expanded="false">	
							<li><a href="<?= base_url('Home/add_agent') ?>">Add Agent</a></li>
							<li><a href="<?= base_url('view_agent') ?>">Active Agent List</a></li>
							<li><a href="<?= base_url('view_deactive_agent') ?>">Deactive Agent List</a></li>
				...
				<p class="mb-[6px] text-[0.775rem]">Version 1.0 <br>Pesticides Management System © <span class="current-year">2025</span> All Rights Reserved</p>
					...
					<p class="mb-[6px] text-[0.775rem]">Developed By<span class="heart inline-block w-[60px] h-[60px] cursor-pointer"></span>Namami Software</p>
				</div>
			</div>
        </div>		
        <!-- Sidebar end -->