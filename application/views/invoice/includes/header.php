										...
										<a data-dz-dropdown="DzinfoDropdown" class="dz-dropdown nav-link relative p-2 max-sm:p-0 text-[#464a53] text-lg leading-[1] block duration-500 bg-transparent" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
											<div class="header-info2 flex items-center text-right">
												<div class="header-media">
													<img src="<?= base_url() ?>uploads/admin/<?= $admin['0']['image'] ?>" alt="" class="w-[45px] h-[45px] max-sm:w-[40px] max-sm:h-[40px] rounded-md">
												</div>
											</div>
										</a>
											...
											<div class="card border-0 mb-0">
												<div class="card-header relative flex items-center justify-between bg-transparent py-2 sm:px-[1.25rem] px-4 border-b border-[#E6E6E6] dark:border-[#ffffff1a]">
													<div class="flex items-center">
														<img src="<?= base_url() ?>uploads/admin/<?= $admin['0']['image'] ?>" class="avatar avatar-md mr-2.5 h-[2.813rem] w-[2.813rem] inline-block object-cover rounded-md" alt="">
														<div>
															<h6 class="text-sm"><?= $admin['0']['name'] ?></h6>
															<span class="text-xs text-body-color"><?= $admin['0']['company_name'] ?></span>	
														</div>	
													</div>
												</div>
												<div class="card-body sm:py-2 border-b border-[#E6E6E6] dark:border-[#ffffff1a]">
													<a href="<?= base_url() ?>profile" class="dropdown-item py-[0.6rem] px-[1.25rem] block w-full ai-icon hover:bg-primary-light group">
												...
												<div class="card-footer px-0 py-2">
													...
													<a href="<?= base_url('admin/logout') ?>" class="dropdown-item py-[0.6rem] px-[1.25rem] text-base block w-full ai-icon">
