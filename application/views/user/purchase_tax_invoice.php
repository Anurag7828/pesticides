...
<button  id="invoicen1" class="py-2 px-4 bg-primary text-white rounded hover:bg-hover-primary duration-300">Basic Invoice</button>
    ...
    <tr>
        ...
        <td style="width: 50%; padding: 10px; vertical-align: top; border-top: 2px solid black;">
            ...
            <strong>Purchase Code:</strong><?= $user['0']['purchase_code'] ?>-<?= $purchase_product[0]['purchase_code']?><br>
...
if (!empty($customer)) {  
    foreach ($customer as $cus) {
        ...
        $purchaseInvoiceUrl = base_url('Admin_Dashboard/purchase_tax_invoice/' . encryptId($user[0]['id']) . '/' . $purchase_product['0']['purchase_code']);
?>
<script>
