...
<body class="selection:text-white selection:bg-primary">
    ...
    ?>
                                                            ...
                                                            <?php
                                                            $payment = $this->CommonModal->getRowByIdOrderByLimit('return_purchase_payment', 'return_code', $return_info['return_code'], 'user_id', $user['0']['id'], 'id', 'DESC', '1');
                                                            $paymentsum = $this->CommonModal->getRowByIdSum('return_purchase_payment', 'return_code', $return_info['return_code'], 'user_id', $user['0']['id'], 'paid');
                                                            ?>
                                                            <td
                                                                class="border-b border-b-color py-2.5 px-4 text-[13px] font-normal text-body-color whitespace-nowrap">
                                                                ...
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dz-dropdown-menu dropdown-menu-end border py-2 rounded-md min-w-[10rem] z-[9] translate-x-[-96px] translate-y-1 shadow-[0_0_3.125rem_0_rgba(82,63,105,0.15)] overflow-hidden border-b-color absolute bg-white dark:bg-[#182237] dark:shadow-[0rem_0rem_0rem_0.0625rem_rgba(255,255,255,0.1)] hidden"
                                                                        ...
                                                                        <a class="dropdown-item py-2 px-5 text-body-color text-[13px] text-left block w-full whitespace-nowrap hover:bg-[#f8f9fa] hover:text-primary dark:hover:bg-[#151C2C]"
                                                                            href="<?= base_url('Admin_Dashboard/print_return_purchase/' . encryptId($user[0]['id']) . '/' . $return_info['return_code']); ?>">
                                                                            View Return
                                                                        </a>
                                                                        ...
                                                                        <a class="dropdown-item py-2 px-5 text-body-color text-[13px] text-left block w-full whitespace-nowrap hover:bg-[#f8f9fa] hover:text-primary dark:hover:bg-[#151C2C]"
                                                                            ...
                                                                            Due Payment</a>
                                                                        <a class="dropdown-item py-2 px-5 text-body-color text-[13px] text-left block w-full whitespace-nowrap hover:bg-[#f8f9fa] hover:text-primary dark:hover:bg-[#151C2C]"
                                                                            href="<?= base_url('Admin_Dashboard/return/' . encryptId($user[0]['id']) . '?return_code=' . $return_info['return_code']); ?>"
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row mb-12">
                                                                ...
                                                                <div class="mt-6 lg:w-1/2 md:w-1/2 w-full detail">
                                                                    ...
                                                                    <?php
                                                                    $vender = $this->CommonModal->getRowByMultitpleId('vender', 'id', $return_info['vender_name'], 'user_id', $user['0']['id']);
                                                                    ?>
                                                                ...
                                                                <table>
                                                                    ...
                                                                    <tbody>
                                                                        <?php
                                                                        $paymentall = $this->CommonModal->getRowByMultitpleId('return_purchase_payment', 'return_code', $return_info['return_code'], 'user_id', $user['0']['id']);
                                                                        $i = 0;
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row mb-12">
                                                                ...
                                                                <form class="profile-form"
                                                                    action="<?= base_url('admin_Dashboard/add_return_purchase_payment/' . encryptId($user['0']['id'])) ?>"
