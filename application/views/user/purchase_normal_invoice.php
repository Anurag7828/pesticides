...
?>
 ...
 document.getElementById('saveButton').addEventListener('click', function () {
            alert("Invoice saved");
              window.location.href = "<?php echo base_url('Admin_Dashboard/product/' . encryptId($user['0']['id'])); ?>";
        });
...
document.getElementById('printBtn').addEventListener('click', function() {
 ...
 document.getElementById('invoicen').addEventListener('click', function() {
            ...
            window.location.href = "<?= base_url('Admin_Dashboard/purchase_tax_invoice/' . encryptId($user['0']['id']) . '/' . $purchase_product[0]['purchase_code']); ?>";
        });
...
if (!empty($customer)) {  
    foreach ($customer as $cus) {
        ...
        $purchaseInvoiceUrl = base_url('Admin_Dashboard/purchase_normal_invoice/' . encryptId($user[0]['id']) . '/' . $purchase_product['0']['purchase_code']);
?>
<script>
        ...
        const generateButton = document.getElementById('generatePDF');
            ...
            const saveButton = document.getElementById('saveButton');
                        const invoiceButton = document.getElementById('invoicen');
                              const invoiceButton2 = document.getElementById('invoicen2');
