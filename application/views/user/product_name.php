		...
		<div class="content-body">
			<div class="container-fluid">
				<div class="row dz-tab-area">
                    ...
                    <a href="<?= base_url('admin_Dashboard/add_product_name/'.encryptId($user['0']['id']).'/0') ?>" class="py-[5px] px-3 text-[13px] rounded text-white bg-primary leading-[18px] inline-block border border-primary duration-500 hover:bg-hover-primary hover:border-hover-primary ml-auto">Add Product</a><br>
                    <a href="<?= base_url('admin_Dashboard/bulk_upload/'.encryptId($user['0']['id'])) ?>" class="py-[5px] px-3 text-[13px] rounded text-white bg-primary leading-[18px] inline-block border border-primary duration-500 hover:bg-hover-primary hover:border-hover-primary ml-2">
    Bulk Upload
</a>
            ...
            <tr>
              ...
              <td class="border-b border-b-color py-2.5 px-4 text-[13px] font-normal text-body-color address-wrap"><?= $product_name_info['company_name']; ?></td>
               <?php if( $product_name_info['branch_id'] != 0){ 
                    ...
                    <a class="button" style="width:90px;" href="<?= base_url('Admin_Dashboard/view1_product_name?id=' . $product_name_info['id'] . '&user_id=' . $user[0]['id']); ?>">View</a>

                    <a class="button" style="width:90px;" href="<?= base_url('Admin_Dashboard/edit_product_name?id=' . $product_name_info['id'] . '&user_id=' . $user[0]['id']); ?>">Edit</a>
                    <a class="button"  style="width:90px;"  href="<?= base_url('Admin_Dashboard/product_name/' . encryptId($user[0]['id']) . '?id=' . $product_name_info['id']); ?>" onclick="return confirm('Are you sure you want to delete this vendor?')">Delete</a>
               </div>
                </td> 
            </tr>
            <?php
