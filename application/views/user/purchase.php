                        ...
                        <div class="filter cm-content-box box-primary relative rounded mb-4 bg-white dark:bg-[#182237]">
                            ...
                            <div class="content form excerpt border-t border-b-color dark:border-[#ffffff1a]">
                                <form class="profile-form"
                                    action="<?= base_url('admin_Dashboard/purchase/' . encryptId($user['0']['id'])) ?>"
    ...
    <tbody>
        <?php 
            ...
            foreach ($purchases as $product): 
                ...
                $payment = $this->CommonModal->getRowByIdOrderByLimit('purchase_payment', 'purchase_code', $product['purchase_code'], 'user_id', $user[0]['id'], 'id', 'DESC', '1');
                $paymentsum = $this->CommonModal->getRowByIdSum('purchase_payment', 'purchase_code', $product['purchase_code'], 'user_id', $user[0]['id'], 'paid');
