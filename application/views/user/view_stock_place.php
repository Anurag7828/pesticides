		...
		<div class="content-body">
			<div class="container-fluid">
				<div class="row dz-tab-area">
                    ...
                    <a href="<?= base_url('admin_Dashboard/add_stock_place/'.encryptId($user['0']['id']).'/0') ?>" class="py-[5px] px-3 text-[13px] rounded text-white bg-primary leading-[18px] inline-block border border-primary duration-500 hover:bg-hover-primary hover:border-hover-primary ml-auto">+ add stock Place</a><br>
    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td class="border-b border-b-color py-2.5 px-4 text-[13px] font-normal text-body-color break-words"><?= $stock_place_info['place_name'] ?></td>
                <td class="border-b border-b-color py-2.5 px-4 text-[13px] font-normal text-body-color address-wrap"><?= $stock_place_info['address'] ?></td>
                ...
                <td class="border-b border-b-color py-2.5 px-4 text-[13px] font-normal text-body-color whitespace-nowrap">
                    ...
                    <a class="button" href="<?= base_url('Admin_Dashboard/edit_stock_place?id=' . $stock_place_info['id']. '&user_id='.$user['0']['id']); ?>">Edit</a>
