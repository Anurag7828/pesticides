...
<button  id="invoicen1" class="py-2 px-4 bg-primary text-white rounded hover:bg-hover-primary duration-300">Basic Invoice</button>
    ...
    <tr>
        <td style="width: 50%; padding: 10px; vertical-align: top; border-top: 2px solid black;border-right: 2px solid black;">
                ...
                <strong>Address:-</strong>     <span style="display: block; max-width: 400px; word-wrap: break-word; white-space: normal;">
                  <?= $vender[0]['address'] ?>
                </span>
...
if (!empty($customer)) {  
    foreach ($customer as $cus) {
        ...
        $returnPurchaseInvoiceUrl = base_url('Admin_Dashboard/print_return_purchase_tax/' . encryptId($user[0]['id']) . '/' . $returnCode);
?>
<script>
