                    ...
                    <div class="w-full">
                        <div class="filter cm-content-box box-primary relative rounded mb-4 bg-white dark:bg-[#182237]">
                            ...
                            <div class="content form excerpt border-t border-b-color dark:border-[#ffffff1a]">
                                <form class="profile-form"
                                    action="<?= base_url('admin_Dashboard/sales_return/' . encryptId($user['0']['id'])) ?>"
                                    ...
                                    <div class="sm:p-5 p-4">
										...
										<div class="sm:w-1/4 w-full mb-[30px]">
                                            ...
                                            <div class="xl:w-1/4 sm:w-1/2 w-full self-end">
                                                ...
                                                <a
                                                    href="<?= base_url('Admin_Dashboard/sales_return/' . encryptId($user['0']['id'])) ?>"><button
						...
						<div class="card">
							<div class="card-header flex justify-between sm:pt-6 pb-0 py-5 sm:px-5 px-4 items-center relative flex-wrap">
								<h4 class="text-base">Sales Return Report</h4>
    ...
    <tbody>
        <?php 
            ...
            foreach ($invoice_r as $product): 
                ...
                $payment = $this->CommonModal->getRowByIdOrderByLimit('return_invoice_payment', 'return_invoice_no', $product['return_invoice_no'], 'user_id', $user[0]['id'], 'id', 'DESC', '1');
                $paymentsum = $this->CommonModal->getRowByIdSum('return_invoice_payment', 'return_invoice_no', $product['return_invoice_no'], 'user_id', $user[0]['id'], 'paid');
