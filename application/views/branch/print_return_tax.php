...
<button  id="invoicen1" class="py-2 px-4 bg-primary text-white rounded hover:bg-hover-primary duration-300">Basic Invoice</button>
        ...
        <div class="invoice-box">
            <div class="header-box">Tax Return Invoice</div>
    ...
    <tr>
        ...
        <td style="width: 50%; padding: 10px; vertical-align: top; border-top: 2px solid black;">
            ...
            <strong>Return Invoice No:</strong> <?= isset($user[0]['returne_code']) ? $user[0]['returne_code'] : '' ?>-<?= isset($invoice[0]['return_invoice_no']) ? $invoice[0]['invoice_no'] : '' ?><br>
                ...
                <table class=" table-striped w-auto text-nowrap table-bordered w-auto text-nowrap"style=" border-collapse: collapse; border: 2px solid black; ">
                    ...
                    <tbody>
                        <?php
                            ...
                            if (!empty($invoice_no)) {  // Missing closing parenthesis fixed here
                                foreach ($invoice_no as $row) {  $quantity_total += $row['quantity']; $i++;
                    ?>
                                <tr>
                                    <td><?= $i ?></td>
                                     <?php 
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td style=" border: 1px solid #000;" >₹<?= $row['grand_total']?> /-</td>
                        </tr>
                    </tfoot>
                </table>
...
if (!empty($customer)) {  
    foreach ($customer as $cus) {
        ...
        $invoiceUrl = base_url('Branch_Dashboard/print_return_invoice_tax/' . encryptId($user['0']['id']) . '/' . $invoice['0']['invoice_no']);
?>
<script>
