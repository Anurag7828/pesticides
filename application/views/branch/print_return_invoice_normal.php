...
if (!empty($customer)) {  
    foreach ($customer as $cus) {
        ...
        $invoiceUrl = base_url('Branch_Dashboard/print_return_invoice_normal/' . encryptId($user['0']['id']) . '/' . $invoice['0']['invoice_no']);
?>
 <script>
    document.getElementById('whatsappBtn').addEventListener('click', function() {
        ...
        let invoice_no = "<?= $invoice[0]['invoice_no'] ?>";
...
document.getElementById('invoicen').addEventListener('click', function() {
        ...
        document.getElementById('invoicen1').addEventListener('click', function() {
            ...
            // Redirect to the desired page after the alert
            window.location.href = "<?= base_url('Branch_Dashboard/print_return_invoice/' . encryptId($user[0]['id']) . '/' .$invoice[0]['return_invoice_no']); ?>";
        });
