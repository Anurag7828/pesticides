                                                ...
                                                if (!empty($return)): ?>
                                                    <?php foreach ($return as $return_info): ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td
                                                                class="border-b border-b-color py-2.5 px-4 text-[13px] font-normal text-body-color whitespace-nowrap">
                                                                <?= $u[0]['returne_code'] ?>-<?= $return_info['return_invoice_no'] ?>
                                                            </td>
                                                            <td
                                                                class="border-b border-b-color py-2.5 px-4 text-[13px] font-normal text-body-color whitespace-nowrap">
                                                            ...
                                                            <td
                                                                class="border-b border-b-color py-2.5 px-4 text-[13px] font-normal text-body-color whitespace-nowrap">
                                                                ₹ <?= number_format((float)$return_info['final_total'], 2) ?></td>
                                                            <?php
                                                            $payment = $this->CommonModal->getRowByIdOrderByLimit('return_invoice_payment', 'return_invoice_no', $return_info['return_invoice_no'], 'user_id', $user['0']['user_id'], 'id', 'DESC', '1');
                                                            $paymentsum = $this->CommonModal->getRowByIdSum('return_invoice_payment', 'return_invoice_no', $return_info['return_invoice_no'], 'user_id', $user['0']['user_id'], 'paid');
                                                            ?>
                                                            <td
                                                                class="border-b border-b-color py-2.5 px-4 text-[13px] font-normal text-body-color whitespace-nowrap">
                                                                ...
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dz-dropdown-menu dropdown-menu-end border py-2 rounded-md min-w-[10rem] z-[9] translate-x-[-96px] translate-y-1 shadow-[0_0_3.125rem_0_rgba(82,63,105,0.15)] overflow-hidden border-b-color absolute bg-white dark:bg-[#182237] dark:shadow-[0rem_0rem_0rem_0.0625rem_rgba(255,255,255,0.1)] hidden"
                                                                        ...
                                                                        <a class="dropdown-item py-2 px-5 text-body-color text-[13px] text-left block w-full whitespace-nowrap hover:bg-[#f8f9fa] hover:text-primary dark:hover:bg-[#151C2C]"
                                                                            href="<?= base_url('Branch_Dashboard/print_return_invoice/' . encryptId($user[0]['id']) . '/' . $return_info['return_invoice_no']); ?>">
                                                                            View Return
                                                                        </a>
                                                                       
                                                                        <a class="dropdown-item py-2 px-5 text-body-color text-[13px] text-left block w-full whitespace-nowrap hover:bg-[#f8f9fa] hover:text-primary dark:hover:bg-[#151C2C]"
                                                                            href="<?= base_url('Branch_Dashboard/edit_return_invoice?user_id=' . $user['0']['id'] . '&return_invoice_no=' . $return_info['return_invoice_no']) ?>">Edit</a>
                                                                        ...
                                                                        <a class="dropdown-item py-2 px-5 text-body-color text-[13px] text-left block w-full whitespace-nowrap hover:bg-[#f8f9fa] hover:text-primary dark:hover:bg-[#151C2C]"
                                                                            ...
                                                                            Due Payment</a>
                                                                        <!-- <a class="dropdown-item py-2 px-5 text-body-color text-[13px] text-left block w-full whitespace-nowrap hover:bg-[#f8f9fa] hover:text-primary dark:hover:bg-[#151C2C]" href="<?= base_url('Branch_Dashboard/view_return_invoice?user_id=' . encryptId($user[0]['id']) . '&r_id=' . $return_info['return_invoice_no']); ?>" onclick="return confirm('Are you sure you want to delete this Account Detail?')">Delete</a> -->
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row mb-12">
                                                                ...
                                                                <div class="mt-6 lg:w-1/2 md:w-1/2 w-full detail">
                                                                    ...
                                                                    <?php
                                                                    $vender = $this->CommonModal->getRowByMultitpleId('customer', 'id', $return_info['customer_name'], 'user_id', $user[0]['user_id']);
                                                                    ?>
                                                                ...
                                                                <table>
                                                                    ...
                                                                    <tbody>
                                                                        <?php
                                                                        $paymentall = $this->CommonModal->getRowByMultitpleId('return_invoice_payment', 'return_invoice_no', $return_info['return_invoice_no'], 'user_id', $user['0']['user_id'], 'user_id', $user['0']['user_id']);
                                                                        $i = 0;
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row mb-12">
                                                                ...
                                                                <form class="profile-form"
                                                                    action="<?= base_url('Branch_Dashboard/add_return_payment/' . encryptId($user['0']['id'])) ?>"
