	...
	<!-- Content body start -->
		<div class="content-body">
			<div class="container-fluid">
                    ...
                    <a href="<?= base_url('Branch_Dashboard/add_stock/'.encryptId($user['0']['id'])) ?>" class="py-[5px] px-3 text-[13px] rounded text-white bg-primary leading-[18px] inline-block border border-primary duration-500 hover:bg-hover-primary hover:border-hover-primary ml-auto">+ Add Stock</a><br>
...
<a href="#" onclick="exportTableAsPDF()" class="py-[5px] px-3 text-[13px] rounded text-white bg-primary leading-[18px] inline-block border border-primary duration-500 hover:bg-hover-primary hover:border-hover-primary ml-2">
  PDF
				...
				<div class="row dz-tab-area">
<!--					<div class="flex justify-between items-center mb-5">-->
                    <!--<a href="<?= base_url('Branch_Dashboard/add_stock/'.encryptId($user['0']['id'])) ?>" class="py-[5px] px-3 text-[13px] rounded text-white bg-primary leading-[18px] inline-block border border-primary duration-500 hover:bg-hover-primary hover:border-hover-primary ml-auto">+ add stock</a><br></div>-->
<!--                    <div class="flex items-center">-->
<!--							<h3 style="font-size: 25px; margin: 10px;color: #454592;">View stock list</h3>-->
        ...
        <?php   $serial = 1;  foreach ($stock as $stock_info) : ?>
           ...
           ?>
            ...
            <td class="border-b border-b-color py-2.5 px-4 text-[13px] font-normal text-body-color whitespace-nowrap"><?= $serial++ ?></td>
                ...
                <td class="border-b border-b-color py-2.5 px-4 text-[13px] font-normal text-body-color whitespace-nowrap"><?= $stock_info['packing']; ?> <?= $stock_info['unit']; ?></td>
               ...
               <td class="border-b border-b-color py-2.5 px-4 text-[13px] font-normal text-body-color whitespace-nowrap"><?= $stock_info['transfer_quantity']; ?></td>
                ...
                <td class="border-b border-b-color py-2.5 px-4 text-[13px] font-normal text-body-color whitespace-nowrap">
                    ...
                    <a class="button" href="<?= base_url('Branch_Dashboard/edit_stock?id=' . $stock_info['p_id'] . '&user_id=' . $user[0]['id']); ?>" onclick="return confirm('Are you sure you want to replace stock place?')">Transfer stock</a>
                    </div>
                </td> 
            </tr>
        <?php endforeach; ?>
