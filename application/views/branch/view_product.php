                                                        ...
                                                        <tr>
                                                            ...
                                                            <td
                                                                ...
                                                                <?php if ($product_info['status']) {
                                                                    ...
                                                                    ?>
                                                                    <a
                                                                        href="<?= base_url('Branch_Dashboard/return/' . encryptId($user['0']['id'])) ?>">
                                                                        <span
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row mb-12">
                                                                ...
                                                                <div class="mt-6 lg:w-1/2 md:w-1/2 w-full detail">
                                                                    ...
                                                                    <?php
                                                                    $vender = $this->CommonModal->getRowById('vender', 'id', $product_info['vender_name'], 'branch_id', $user['0']['id'], 'user_id', $user['0']['user_id']);
                                                                    ?>
                                                                ...
                                                                <table>
                                                                    ...
                                                                    <tbody>
                                                                        <?php
                                                                        $paymentall = $this->CommonModal->getRowByMultitpleId('purchase_payment', 'purchase_code', $product_info['purchase_code'], 'user_id', $user['0']['user_id'], 'user_id', $user['0']['user_id']);
                                                                        $i = 0;
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row mb-12">
                                                                ...
                                                                <div class="mt-6 lg:w-1/2 md:w-1/2 w-full detail">
                                                                    <!-- <h6 class="mb-2">Customer Detail:</h6> -->
                                                                    <?php
                                                                    $vender = $this->CommonModal->getRowByMultitpleId('vender', 'id', $product_info['vender_name'], 'user_id', $user['0']['user_id']);
                                                                    ?>
                                                                    <div class="text-body-color sm:text-sm text-xs">
                                                                        <strong>Vender Name:</strong>
                                                                        <?= $vender[0]['vender_name'] ?></div>
                                                                ...
                                                                <form class="profile-form"
                                                                    action="<?= base_url('Branch_Dashboard/add_purchase_payment/' . encryptId($user['0']['id'])) ?>"
