            ...
            <div class="container-fluid">
                <div class="row dz-tab-area">
                    <div class="flex justify-between items-center mb-5">
                        <a href="<?= base_url('Branch_Dashboard/add_invoice/' . encryptId($user['0']['id'])) ?>"
                                                    ...
                                                    foreach ($invoice as $customer_info) {
                                                        ...
                                                        if (!in_array($uniqueKey, $displayedInvoices)) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td
                                                                    class="border-b border-b-color py-2.5 px-4 text-[13px] font-normal text-body-color whitespace-nowrap">
                                                                    <?= $u[0]['prefix'] ?>-<?= $customer_info['invoice_no'] ?></td>
                                                                ...
                                                                <td
                                                                    ...
                                                                    <?php if ($customer_info['stat']) {
                                                                        ...
                                                                        <a
                                                                            href="<?= base_url('Branch_Dashboard/view_return_invoice/' . encryptId($user['0']['id'])) ?>"><span
                                                                                class="text-xs py-[5px] px-3 rounded leading-[1.5] inline-block text-danger bg-danger-light"><?= $total_return_quantity ?>
                                                                ...
                                                                <td
                                                                    class="border-b border-b-color py-2.5 px-4 text-[13px] font-normal text-body-color whitespace-nowrap">
                                                                    ₹ <?= number_format((float) $customer_info['final_total'], 2) ?>
                                                                </td>
                                                                <?php
                                                                ...
                                                                <td
                                                                    class="border-b border-b-color py-2.5 px-4 text-[13px] font-normal text-body-color whitespace-nowrap">
                                                                    ₹ <?= number_format((float) $paymentsum[0]['total_sum'], 2) ?>
                                                                </td>
                                                                <td
                                                                    class="border-b border-b-color py-2.5 px-4 text-[13px] font-normal text-body-color whitespace-nowrap">
                                                                    ...
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dz-dropdown-menu dropdown-menu-end border py-2 rounded-md min-w-[10rem] z-[9] translate-x-[-96px] translate-y-1 shadow-[0_0_3.125rem_0_rgba(82,63,105,0.15)] overflow-hidden border-b-color absolute bg-white dark:bg-[#182237] dark:shadow-[0rem_0rem_0rem_0.0625rem_rgba(255,255,255,0.1)] hidden"
                                                                            ...
                                                                            <a class="dropdown-item py-2 px-5 text-body-color text-[13px] text-left block w-full whitespace-nowrap hover:bg-[#f8f9fa] hover:text-primary dark:hover:bg-[#151C2C]"
                                                                                href="<?= base_url('Branch_Dashboard/print_invoice/' . encryptId($user['0']['id']) . '/' . $customer_info['invoice_no']); ?>">View
                                                                                Invoice</a>

                                                                            <a class="dropdown-item py-2 px-5 text-body-color text-[13px] text-left block w-full whitespace-nowrap hover:bg-[#f8f9fa] hover:text-primary dark:hover:bg-[#151C2C]"
                                                                                href="<?= base_url('Branch_Dashboard/edit_invoice?user_id=' . $user['0']['id'] . '&invoice_no=' . $customer_info['invoice_no']); ?>">Edit</a>
                                                                            <a class="dropdown-item py-2 px-5 text-body-color text-[13px] text-left block w-full whitespace-nowrap hover:bg-[#f8f9fa] hover:text-primary dark:hover:bg-[#151C2C]"
                                                                            ...
                                                                            <a class="dropdown-item py-2 px-5 text-body-color text-[13px] text-left block w-full whitespace-nowrap hover:bg-[#f8f9fa] hover:text-primary dark:hover:bg-[#151C2C]"
                                                                                href="<?= base_url('Branch_Dashboard/return_invoice?user_id=' . $user['0']['id'] . '&invoice_no=' . $customer_info['invoice_no']); ?>"
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="row mb-12">
                                                                    ...
                                                                    <form class="profile-form"
                                                                        action="<?= base_url('Branch_Dashboard/add_payment/' . encryptId($user['0']['id'])) ?>"
       ...
       step="0.01"
                                                                                ...
                                                                                <div class="sm:w-1/2 w-full mb-[30px]">
                                                                                    ...
                                                                                    <select name="mode"
                                                                                        ...
                                                                                        <option value="Card">CREADIT/DEBIT CARD
                                                                                        </option>
                                                    ...
                                                    <div id="interestModal<?= $customer_info['invoice_no'] ?>" class="custom-modal">
                                                        <div class="custom-modal-content">
                                                            <span class="custom-modal-close"
                                                                onclick="closeinterestModal('<?= $customer_info['invoice_no'] ?>')">&times;</span>
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="row mb-12">
                                                                    ...
                                                                    <div class="mt-6 lg:w-1/2 md:w-1/2 w-full detail">
                                                                        <?php
                                                                        // Fetch Payment Data
                                                                        $payment = $this->CommonModal->getRowByIdOrderByLimit3('payment', 'invoice_no', $customer_info['invoice_no'], 'user_id', $user['0']['user_id'], 'branch_id', $user['0']['id'], 'id', 'DESC', '1');
                                                                        $paymentsum = $this->CommonModal->getRowByIdSum('payment', 'invoice_no', $customer_info['invoice_no'], 'user_id', $user['0']['user_id'], 'paid');
                                                                        ...
                                                                        <div class="text-body-color sm:text-sm text-xs">
                                                                            <strong>Total Amount:</strong>
                                                                            ₹<?= number_format($payment[0]['total'], 2) ?>/-
                                                                        </div>
                                                                        ...
                                                                        <div class="text-body-color sm:text-sm text-xs">
                                                                            <strong>Due Amount:</strong> <span
                                                                                class="text-red-500">₹<?= number_format($due_amount, 2) ?>/-</span>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="w-full mt-6">
                                                                        ...
                                                                        <?php if ($customer_info['include_interest'] == 1 && $customer_info['days_late'] > 0) { ?>
                                                                            <table
                                                                                class="w-full border-collapse border border-gray-300 mt-2 text-center">
                                                                                <thead>
                                                                                    <tr class="bg-gray-200">
                                                                                        ...
                                                                                        <th class="border border-gray-300 px-3 py-2">
                                                                                            Interest Amount</th>
                                                                                        <th class="border border-gray-300 px-3 py-2">
                                                                                            Total with Interest</th>
                                                                                    </tr>
                                                                                </thead>
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="border border-gray-300 px-3 py-2">
                                                                                            <?= $customer_info['interest_rate'] ?>% per
                                                                                            year</td>
                                                                                        <td class="border border-gray-300 px-3 py-2">
                                                                                            <?= $customer_info['last_due_date'] ?></td>
                                                                                        <td class="border border-gray-300 px-3 py-2">
                                                                                            <?= $customer_info['interest_days'] ?> days
                                                                                        </td>
                                                                                        <td class="border border-gray-300 px-3 py-2">
                                                                                            <?= $customer_info['days_late'] ?> days</td>
                                                                                        <td class="border border-gray-300 px-3 py-2">
                                                                                            ₹<?= number_format($customer_info['interest_amount'], 2) ?>/-
                                                                                        </td>
                                                                                        <td class="border border-gray-300 px-3 py-2">
                                                                                            ₹<?= number_format($customer_info['grand_total_with_interest'], 2) ?>/-
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                        <?php } else { ?>
                                                                            <p class="text-red-500 text-sm mt-2">This customer does not
                                                                                have any interest applied.</p>
                                                                        <?php } ?>
                                                                    </div>
