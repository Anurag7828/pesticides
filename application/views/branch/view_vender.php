		...
		<div class="content-body">
			<div class="container-fluid">
				<div class="row dz-tab-area">
                    ...
                    <a href="<?= base_url('Branch_Dashboard/add_vender/'.encryptId($user['0']['id']).'/0') ?>" class="py-[5px] px-3 text-[13px] rounded text-white bg-primary leading-[18px] inline-block border border-primary duration-500 hover:bg-hover-primary hover:border-hover-primary ml-auto">+ add Vender</a><br>
...
<a href="#" onclick="exportTableAsPDF()" class="py-[5px] px-3 text-[13px] rounded text-white bg-primary leading-[18px] inline-block border border-primary duration-500 hover:bg-hover-primary hover:border-hover-primary ml-2">
  PDF
    ...
    <thead>
        <tr>
            ...
            <th class="border-b border-b-color text-[13px] py-2.5 px-4 bg-primary-light text-primary capitalize font-medium bg-none whitespace-nowrap text-left">Add<br>By</th>
    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td class="border-b border-b-color py-2.5 px-4 text-[13px] font-normal text-body-color whitespace-nowrap"><?= $vender_info['vender_name'] ?></td>
                <td class="border-b border-b-color py-2.5 px-4 text-[13px] font-normal text-body-color whitespace-nowrap"><?= $vender_info['mobile'] ?></td>
                                <!-- <td class="border-b border-b-color py-2.5 px-4 text-[13px] font-normal text-body-color whitespace-nowrap"><?= $vender_info['email'] ?></td> -->
 ...
 <?php  $paymentpaid = $this->CommonModal->getRowByIdSum('purchase_payment', 'vender_id',  $vender_info['id'],'user_id',$user[0]['user_id'],'paid');
                                                           $paymenttotal = $this->CommonModal->getRowByIdSumDue('purchase_payment', 'vender_id',  $vender_info['id'],'user_id',$user[0]['user_id'],'total','purchase_code' );
                                                 $payment =  $this->CommonModal->getRowByIdSumDue(
    'purchase_payment',  
    'vender_id',               // Vender column
    $vender_info['id'],       // Vender ID
    'user_id',                // User column
    $user[0]['user_id'],           // User ID
    ...
    'purchase_code'           // Column to group by (purchase_code)
                                                            ...
                                                            <?php if($paymenttotal){ ?>
                                                              ...
                                                              <?php } else { ?>
                                                               ...
                                                               <?php } ?>
                                                                 <?php if( number_format((float)$paymentpaid[0]['total_sum'], 2)){ ?>
...
<?php } else { ?>
    <td class="border-b border-b-color py-2.5 px-4 text-[13px] font-normal text-body-color whitespace-nowrap">
        ₹ 0 /-
                                                               ...
                                                               <td class="border-b border-b-color py-2.5 px-4 text-[13px] font-normal text-body-color whitespace-nowrap"><?= $user[0]['name'] ?></td>
                                                              <?php } else { ?>
                ...
                <div class="dropdown">
                    ...
                    <div class="dz-dropdown-menu dropdown-menu-end border py-2 rounded-md min-w-[10rem] z-[9] translate-x-[-96px] translate-y-1 shadow-[0_0_3.125rem_0_rgba(82,63,105,0.15)] overflow-hidden border-b-color absolute bg-white dark:bg-[#182237] dark:shadow-[0rem_0rem_0rem_0.0625rem_rgba(255,255,255,0.1)] hidden" id="dropdown-<?= $vender_info['id']?>">
                        ...
                        <a class="dropdown-item py-2 px-5 text-body-color text-[13px] text-left block w-full whitespace-nowrap hover:bg-[#f8f9fa] hover:text-primary dark:hover:bg-[#151C2C]" href="<?= base_url('Branch_Dashboard/edit_vender?id=' . $vender_info['id']. '&user_id='.$user['0']['id']); ?>">Edit</a>
...
<a class="dropdown-item py-2 px-5 text-body-color text-[13px] text-left block w-full whitespace-nowrap hover:bg-[#f8f9fa] hover:text-primary dark:hover:bg-[#151C2C]" href="javascript:void(0);" onclick="openModal('<?= $vender_info['id'] ?>')">Payment History</a>
     ...
     <!--                   <a class="dropdown-item py-2 px-5 text-body-color text-[13px] text-left block w-full whitespace-nowrap hover:bg-[#f8f9fa] hover:text-primary dark:hover:bg-[#151C2C]" href="<?= base_url('Branch_Dashboard/vender/' . encryptId($user[0]['id']).'-->
       ...
       <div class="row mb-12">
                    ...
                    ?>
                                            <tr>
                                                ...
                                                <td class="py-[0.9375rem] px-2.5 border-b border-[#E6E6E6] dark:border-[#ffffff1a] whitespace-nowrap sm:text-sm text-xs text-body-color left strong"><?= $u[0]['purchase_code'] ?>-<?= $row['purchase_code']?></td>
