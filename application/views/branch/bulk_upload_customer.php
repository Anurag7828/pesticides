                ...
                <div class="xl:w-6/4 lg:w-4/3">
                    <div class="card flex flex-col max-sm:mb-[30px] profile-card">
                        <div class="card-header flex justify-between items-center flex-wrap sm:p-[30px] p-5 relative z-[2] border-b border-b-color">
                            <h6 class="text-[15px] font-medium text-body-color title relative">Upload Customer CSV File</h6>
                            <a href="<?= base_url('Branch_Dashboard/download_sample_customer_csv') ?>" class="py-[5px] px-3 text-[13px] rounded text-white bg-primary leading-[18px] inline-block border border-primary duration-500 hover:bg-hover-primary hover:border-hover-primary ml-auto">Download Sample</a><br>
                        </div>

                        <form class="profile-form" action="<?= base_url('Branch_Dashboard/upload_customer_csv/' . encryptId($user['0']['id']).'/' . encryptId($user['0']['user_id'])) ?>" method="post" enctype="multipart/form-data">
