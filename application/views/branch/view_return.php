...
<body class="selection:text-white selection:bg-primary">
            ...
            <div class="container-fluid">
                <div class="row dz-tab-area">
                    <div class="flex justify-between items-center mb-5">
                        <a href="<?= base_url('Branch_Dashboard/add_branch/' . encryptId($user['0']['id'])) ?>"
                    ...
                    <div class="flex items-center">
                        <h3 style="font-size: 25px; margin: 10px;color: #454592;">View Return Product list</h3>
                                                ...
                                                <?php if (!empty($return)): ?>
                                                    ...
                                                    foreach ($return as $return_info): ?>
                                                        ...
                                                        foreach ($return as $return_inf) {
                                                            $key = $return_inf['vender_name'] . '_' . $return_inf['return_code'];
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td
                                                                class="border-b border-b-color py-2.5 px-4 text-[13px] font-normal text-body-color whitespace-nowrap">
                                                                <?= date('d-m-Y', strtotime($return_info['date'])) ?></td>
                                                            <td
                                                                class="border-b border-b-color py-2.5 px-4 text-[13px] font-normal text-body-color address-wrap">
                                                                <?= $return_info['vender_name'] ?></td>
                                                            <td
                                                                class="border-b border-b-color py-2.5 px-4 text-[13px] font-normal text-body-color whitespace-nowrap">
                                                                <?= $u[0]['returne_code'] ?>-<?= $return_info['return_code'] ?>
                                                            </td>
                                                            <td
                                                                class="border-b border-b-color py-2.5 px-4 text-[13px] font-normal text-body-color whitespace-nowrap">
    ...
    ?>
                                                            ...
                                                            <td
                                                                class="border-b border-b-color py-2.5 px-4 text-[13px] font-normal text-body-color whitespace-nowrap">
                                                                ₹ <?= number_format((float)$return_info['grand_total'], 2) ?></td>
                                                            <?php
                                                            $payment = $this->CommonModal->getRowByIdOrderByLimit('return_purchase_payment', 'return_code', $return_info['return_code'], 'user_id', $user['0']['user_id'], 'id', 'DESC', '1');
                                                            $paymentsum = $this->CommonModal->getRowByIdSum('return_purchase_payment', 'return_code', $return_info['return_code'], 'user_id', $user['0']['user_id'], 'paid');
                                                            ?>
                                                            <td
                                                                class="border-b border-b-color py-2.5 px-4 text-[13px] font-normal text-body-color whitespace-nowrap">
                                                            ...
                                                            <td
                                                                ...
                                                                <div class="dropdown">
                                                                    <button type="button"
                                                                        ...
                                                                        data-dz-dropdown="dropdown-<?= $return_info['return_code'] ?>">
                                                                    ...
                                                                    <div class="dz-dropdown-menu dropdown-menu-end border py-2 rounded-md min-w-[10rem] z-[9] translate-x-[-96px] translate-y-1 shadow-[0_0_3.125rem_0_rgba(82,63,105,0.15)] overflow-hidden border-b-color absolute bg-white dark:bg-[#182237] dark:shadow-[0rem_0rem_0rem_0.0625rem_rgba(255,255,255,0.1)] hidden"
                                                                        id="dropdown-<?= $return_info['return_code'] ?>">
                                                                        <a class="dropdown-item py-2 px-5 text-body-color text-[13px] text-left block w-full whitespace-nowrap hover:bg-[#f8f9fa] hover:text-primary dark:hover:bg-[#151C2C]"
                                                                            href="<?= base_url('Branch_Dashboard/print_return_purchase/' . encryptId($user[0]['id']) . '/' . $return_info['return_code']); ?>">
                                                                            View Return
                                                                        </a>
                                                                         
                                                                        <a class="dropdown-item py-2 px-5 text-body-color text-[13px] text-left block w-full whitespace-nowrap hover:bg-[#f8f9fa] hover:text-primary dark:hover:bg-[#151C2C]"
                                                                            href="<?= base_url('Branch_Dashboard/edit_return?user_id=' . $user['0']['id'] . '&return_code=' . $return_info['return_code']) ?>">Edit</a>
                                                                        <a class="dropdown-item py-2 px-5 text-body-color text-[13px] text-left block w-full whitespace-nowrap hover:bg-[#f8f9fa] hover:text-primary dark:hover:bg-[#151C2C]"
                                                                        ...
                                                                        <a class="dropdown-item py-2 px-5 text-body-color text-[13px] text-left block w-full whitespace-nowrap hover:bg-[#f8f9fa] hover:text-primary dark:hover:bg-[#151C2C]"
                                                                            href="javascript:void(0);"
                                                                            onclick="dueModal('<?= $return_info['return_code'] ?>')">Pay
                                                                            Due Payment</a>
                                                                        <!--<a class="dropdown-item py-2 px-5 text-body-color text-[13px] text-left block w-full whitespace-nowrap hover:bg-[#f8f9fa] hover:text-primary dark:hover:bg-[#151C2C]" href="<?= base_url('Branch_Dashboard/return/' . encryptId($user[0]['id']) . '?return_code=' . $return_info['return_code']); ?>" onclick="return confirm('Are you sure you want to delete this Account Detail?')">Delete</a>-->
                                        ...
                                        <?php if (!empty($return)): ?>
                                            <?php foreach ($return as $return_info): ?>
                                                ...
                                                ?>
                                                <div id="paymentModal<?= $return_info['return_code'] ?>" class="custom-modal">
                                                    <div class="custom-modal-content">
                                                        <span class="custom-modal-close"
                                                            onclick="closeModal('<?= $return_info['return_code'] ?>')">&times;</span>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row mb-12">
                                                                ...
                                                                <div class="mt-6 lg:w-1/2 md:w-1/2 w-full detail">
                                                                    ...
                                                                    <?php
                                                                    $vender = $this->CommonModal->getRowByMultitpleId('vender', 'id', $return_info['vender_name'], 'user_id', $user['0']['user_id']);
                                                                    ?>
                                                                    ...
                                                                    <div class="text-body-color sm:text-sm text-xs">
                                                                        ...
                                                                        <?= $user[0]['returne_code'] ?>-<?= $return_info['return_code'] ?>
                                                                    </div>
                                                                    <div class="text-body-color sm:text-sm text-xs">
                                                                ...
                                                                <table>
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            <th
                                                                                ...
                                                                                Bank/Cheque</th>
                                                                            <th
                                                                                class="py-[0.9375rem] px-2.5 border-b border-[#E6E6E6] dark:border-[#ffffff1a] whitespace-nowrap  sm:text-base text-sm font-medium text-right text-dark">
                                                                                Received by</th>
                                                                    ...
                                                                    <tbody>
                                                                        <?php
                                                                        $paymentall = $this->CommonModal->getRowByMultitpleId('return_purchase_payment', 'return_code', $return_info['return_code'], 'user_id', $user['0']['user_id'], 'user_id', $user['0']['user_id']);
                                                                        $i = 0;
                                                                        if (!empty($paymentall)) {  // Missing closing parenthesis fixed here
                                                                            foreach ($paymentall as $row) {
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    if ($row['branch_id']) { ?>
                                                                                        <td
                                                                                            class="py-[0.9375rem] px-2.5 border-b border-[#E6E6E6] dark:border-[#ffffff1a] whitespace-nowrap sm:text-sm text-xs text-body-color text-right">
                                                                                            By Own</td>
                                                                                    <?php } else { ?>
                                                                                        <td
                                                                                            class="py-[0.9375rem] px-2.5 border-b border-[#E6E6E6] dark:border-[#ffffff1a] whitespace-nowrap sm:text-sm text-xs text-body-color text-right">
                                                ...
                                                <div id="payModal<?= $return_info['return_code'] ?>" class="custom-modal">
                                                    <div class="custom-modal-content">
                                                        <span class="custom-modal-close"
                                                            onclick="closeM('<?= $return_info['return_code'] ?>')">&times;</span>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row mb-12">
                                                                ...
                                                                <form class="profile-form"
                                                                    action="<?= base_url('Branch_Dashboard/add_return_purchase_payment/' . encryptId($user['0']['id'])) ?>"
                                                                    ...
                                                                    <div class="sm:p-10 sm:pb-2.5 p-[25px] pb-0">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="sm:w-1/2 w-full mb-[30px]">
                                                                                ...
                                                                                <input type="date"
                                                                                    id="paymentDate<?= $return_info['return_code'] ?>"
                                                                                    name="date"
    ...
    id="paidAmount<?= $return_info['return_code'] ?>" 
    oninput="validatePaidAmount('<?= $return_info['return_code'] ?>')">
                                                                                ...
                                                                                <input type="hidden" name="purchase_code"
                                                                                    class="form-control relative text-[13px] text-body-color h-[2.813rem] border border-b-color block rounded-md py-1.5 px-3 duration-500 outline-none w-full relative text-[13px] text-body-color h-[2.813rem] border border-b-color block rounded-md py-1.5 px-3 duration-500  outline-none w-full"
                                                                                    placeholder="paid amount"
                                                                                    value="<?= $return_info['purchase_code'] ?>">
                                                                                <input type="hidden" name="return_code"
                                                                                    class="form-control relative text-[13px] text-body-color h-[2.813rem] border border-b-color block rounded-md py-1.5 px-3 duration-500 outline-none w-full relative text-[13px] text-body-color h-[2.813rem] border border-b-color block rounded-md py-1.5 px-3 duration-500  outline-none w-full"
                                                                                    placeholder="paid amount"
                                                                                    value="<?= $return_info['return_code'] ?>">
                                                                            ...
                                                                            <div class="sm:w-1/2 w-full mb-[30px]">
                                                                                ...
                                                                                <select name="mode"
                                                                                    ...
                                                                                    id="paymentMode<?= $return_info['return_code'] ?>"
                                                                                    required>
                                                                            ...
                                                                            <div class="sm:w-1/2 w-full mb-[30px]"
                                                                                id="bankDetails<?= $return_info['return_code'] ?>"
                                                                                style="display:none;">
                                                                                <label
                                                                                    class="text-dark dark:text-white text-[13px] mb-2">Account</label>
                                                                                <select name="bank"
                                                                                    class="form-control relative text-[13px] text-body-color h-[2.813rem] border border-b-color block rounded-md py-1.5 px-3 duration-500 outline-none w-full "
                                                                                    id="bankAccount<?= $return_info['return_code'] ?>">
                                                                                    <option value="">--SELECT--</option>
                                                                                    <?php
                                                                             ...
                                                                             <div class="sm:w-1/2 w-full mb-[30px]"
                                                                                    id="chequeDetails<?= $return_info['return_code'] ?>"
                                                                                    style="display:none;">
                                                                                    <label
                                                            ...
                                                            <input type="text" name="cheque_no"
                                                                                       ...
                                                                                       id="cheque<?= $return_info['return_code'] ?>" >
                                                                                </div>
                                                                        </div>
                                                                    </div>
                                                                    <div
                                                            ...
                                                            <script>
                                                                 document.getElementById('paymentMode<?= $return_info['return_code'] ?>').addEventListener('change', function () {
                                                                    var bankDetails = document.getElementById('bankDetails<?= $return_info['return_code'] ?>');
                                                                      var selectDetails = document.getElementById('bankAccount<?= $return_info['return_code'] ?>');
                                                                    if (this.value === 'Bank') {
                                                                ...
                                                                document.addEventListener("DOMContentLoaded", function () {
                                                                    ...
                                                                    document.getElementById('paymentDate<?= $return_info['return_code'] ?>').value = currentDate;
                                                                });
                                                                   document.getElementById('paymentMode<?= $return_info['return_code'] ?>').addEventListener('change', function () {
                                                                        var chequeDetails = document.getElementById('chequeDetails<?= $return_info['return_code'] ?>');
                                                                          var selectDetails = document.getElementById('cheque<?= $return_info['return_code'] ?>');
...
<script>
    function exportTableToExcel() {
        ...
        XLSX.utils.book_append_sheet(workbook, worksheet, "Return Product List");

        // Generate Excel file and download
        XLSX.writeFile(workbook, "Return_Product.xlsx");
    }
