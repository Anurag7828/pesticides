                            ...
                            <div class="sm:p-5 p-4 flex-auto">
                                ...
                                <div class="mt-6 lg:w-1/4 md:w-1/2 w-full detail">
									...
									<div class="mt-6 lg:w-1/3 md:w-1/2 w-full detail">
										...
										<div class="text-body-color sm:text-sm text-xs break-words"><strong>Shop Name.:</strong> <?= $user_main['0']['name'] ?></div>
 ...
 $paymentsum = $this->CommonModal->getRowByIdSum('return_purchase_payment', 'return_code', $purchase_product['0']['return_code'],'branch_id',$user['0']['id'],'paid');
    ...
    if (!empty($customer)) {  
        foreach ($customer as $cus) {
            ...
            $invoiceUrl = base_url('Branch_Dashboard/print_return_purchase/' . encryptId($user[0]['id']) . '/' . $purchase_product[0]['return_code']);
?>
<script>
