                    ...
                    <div class="xl:w-6/4 lg:w-4/3">
                        <div class="card flex flex-col max-sm:mb-[30px] profile-card">
                            ...
                            <form class="profile-form"
                                action="<?= base_url('Branch_Dashboard/edit_invoice?user_id=' . $user[0]['id'] . '&invoice_no=' . $invoice[0]['invoice_no']) ?>"
                                                                    ...
                                                                    <div id="product-container">
                                                                        ...
                                                                        <div class="row product-row"
                                                                            ...
                                                                            <div class="sm:w-1/4 w-full mb-[30px]">
                                                                                ...
                                                                                <?php $product_name = $this->CommonModal->getRowByMultitpleId('product', 'id', $p_info['p_name'], 'user_id', $user[0]['user_id']); ?>
                                                                                <input type="text"
           ...
           border border-b-color block rounded-md py-1.5 px-3 outline-none w-full"
                                                                            ...
                                                                            <div class="mb-[30px] d-flex align-items-center"
                                                                                ...
                                                                                <a class="btn btn-danger border border-b-color block rounded-md py-1.5 px-3 outline-none"
                                                                                    href="<?= base_url('Branch_Dashboard/delete_invoice' . '?BdID=' . $p_info['id'] . '&UI=' . $p_info['user_id'] . '&inv=' . $p_info['invoice_no'] . '&p_id=' . $p_info['packing']); ?>"
                                                            ...
                                                            <hr>
                                                            <?php
                                                            $invoice_payment = $this->CommonModal->getRowByIdOrderByLimit3('payment', 'invoice_no', $invoice[0]['invoice_no'], 'branch_id',$user[0]['id'],'user_id', $user_id[0]['user_id'], 'id', 'ASC', '1');
                                                            ?>
                                                            <div class="row">
