                            ...
                            <div class="sm:p-5 p-4 flex-auto">
                                ...
                                <div class="mt-6 lg:w-1/4 md:w-1/2 w-full detail">
									...
									<div class="mt-6 lg:w-1/3 md:w-1/2 w-full detail">
										...
										<div class="text-body-color sm:text-sm text-xs break-words"><strong>Shop Name.:</strong> <?= $u['0']['name'] ?></div>
...
if (!empty($customer)) {  
    foreach ($customer as $cus) {
        ...
        $invoiceUrl = base_url('Branch_Dashboard/print_invoice/' . encryptId($user['0']['id']) . '/' . $invoice['0']['invoice_no']);
?>
<script>
