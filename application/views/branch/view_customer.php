            ...
            <div class="container-fluid">
                <div class="row dz-tab-area">
                    <div class="flex justify-between items-center mb-5">
                        <a href="<?= base_url('Branch_Dashboard/add_customer/' . encryptId($user['0']['id']).'/0') ?>" class="py-[5px] px-3 text-[13px] rounded text-white bg-primary leading-[18px] inline-block border border-primary duration-500 hover:bg-hover-primary hover:border-hover-primary ml-auto">+ add Customer</a><br>
                        	<a href="<?= base_url('Branch_Dashboard/add_branch/'.encryptId($user['0']['id'])) ?>" class="py-[5px] px-3 text-[13px] rounded text-white bg-primary leading-[18px] inline-block border border-primary duration-500 hover:bg-hover-primary hover:border-hover-primary ml-2">+ Add User</a>
  ...
  PDF
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td class="border-b border-b-color py-2.5 px-4 text-[13px] font-normal text-body-color whitespace-nowrap address-wrap"><?= $customer_info['address'] ?></td>
                                                        
                                                        
                                                            <?php  $paymentpaid = $this->CommonModal->getRowByIdSum('payment', 'customer_id',  $customer_info['id'],'user_id',$user[0]['user_id'],'paid');
                                                           $paymenttotal = $this->CommonModal->getRowByIdSumDue('payment', 'customer_id',  $customer_info['id'],'user_id',$user[0]['user_id'],'total','invoice_no');
                                                        $payment = $this->CommonModal->getRowByIdSumDue('payment', 'customer_id',  $customer_info['id'],'user_id',$user[0]['user_id'],'due','invoice_no');?>
                                                            <?php if($paymenttotal){ ?>
                ...
                <div class="dropdown">
                    ...
                    <div class="dz-dropdown-menu dropdown-menu-end border py-2 rounded-md min-w-[10rem] z-[9] translate-x-[-96px] translate-y-1 shadow-[0_0_3.125rem_0_rgba(82,63,105,0.15)] overflow-hidden border-b-color absolute bg-white dark:bg-[#182237] dark:shadow-[0rem_0rem_0rem_0.0625rem_rgba(255,255,255,0.1)] hidden" id="dropdown-<?= $customer_info['id'] ?>">
                        ...
                        <a class="dropdown-item py-2 px-5 text-body-color text-[13px] text-left block w-full whitespace-nowrap hover:bg-[#f8f9fa] hover:text-primary dark:hover:bg-[#151C2C]" href="<?= base_url('Branch_Dashboard/edit_customer?id=' . $customer_info['id'] . '&user_id=' . $user['0']['id']); ?>">Edit</a>
       ...
       <div class="row mb-12">
                    ...
                    ?>
                                            <tr>
                                                ...
                                                <td class="py-[0.9375rem] px-2.5 border-b border-[#E6E6E6] dark:border-[#ffffff1a] whitespace-nowrap sm:text-sm text-xs text-body-color left strong"><?= $u[0]['prefix'] ?>-<?= $row['invoice_no']?></td>
